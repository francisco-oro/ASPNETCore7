...
namespace ContactsManager.Core.Domain.RepositoryContracts
{
    ...
    public interface ICountriesRepository
    {
        ...
        /// <summary>
        /// Returns a country object based on the given country id; otherwise, it returns nulll
        /// </summary>
        ...
        /// <returns>Matching country or null if the country name is not found</returns>
